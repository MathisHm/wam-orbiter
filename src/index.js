...
// DSP part
import OrbiterWamNode from './Node.js';
// GUI part
 ...
 * 
 * @extends {WebAudioModule<OrbiterWamNode>}
 */
export default class OrbiterWam extends WebAudioModule {
	...
	async createAudioNode(initialState) {
		...
		const node = new OrbiterWamNode(this.audioContext);
	...
	/**
	 * @param {import('./Gui').OrbiterWamElement} el
	 */
	destroyGui(el) {
